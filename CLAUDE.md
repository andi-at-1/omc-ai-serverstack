...
- **Always read `PLANNING.md`** at the start of a new conversation to understand the project's architecture, goals, style, and constraints. Adapt and expand that if the architecture changes.
...
- **Update `README.md` and `PLANNING.md`** when new features are added, dependencies change, or setup steps are modified.
